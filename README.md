...
# 💫 Yadwandra Thuwal
### **Curious Coder & Software Developer** • *Building Modern Tech & Web Solutions*
...
## 📌 About Me
* 🚀 **Curious Coder & Software Developer** passionate about exploring new technologies
* 🎓 **B.Tech in Computer Science & Engineering** (Final Year)
* ⚡ Building scalable web, mobile & full-stack applications with modern design systems
* 📦 Published reusable component libraries on **npm** with **Storybook**
* 🤖 Experimenting with **AI Tools**, **Browser Extensions** & novel software tools
* 💬 **Ask me about:** Web & Mobile Dev, Design Systems, Clean Architecture & Tech
* 🙋‍♂️ **Pronouns:** He / Him
...
## 🚀 Projects & Highlights
* 📦 **NPM UI Component Library**: Published UI component library documented with Storybook.
* 🧩 **Chrome Extension**: Productivity utility extension for browser automation and tab management.
* 📱 **Flutter + Firebase App**: Mobile application with real-time database sync and authentication.
* 📅 **Full-Stack Booking Platform**: Scheduling system with multi-role access control and database integration.
